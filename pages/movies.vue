              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  <div class="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <iframe
                      v-if="movie.videoSrc"
                      :src="`${movie.videoSrc}?rel=0&modestbranding=1`"
                ...
                >
                  ...
                  <!-- Title -->
                  <h2 class="text-3xl md:text-4xl font-bold text-brand-gradient">
                    {{ movie.title }}
                  </h2>
...
import whispersImage from '~/assets/images/pages/movies/whispers_of_the_valley.png'
